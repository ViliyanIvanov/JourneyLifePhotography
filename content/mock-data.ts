...
export const mockServices: Service[] = [
  {
    ...
    features: [
      "Full day coverage – morning prep to first dance (8–10 hours)",
  ...
  },
  {
    ...
    features: [
      ...
      "Location or home setting",
      "20–30 beautifully edited digital images",
  ...
  },
  {
    ...
    tagline: "Professional imagery for your business",
    description:
      "Elevate your business with polished corporate photography — from team headshots and conferences to product launches and business storytelling.",
    features: [
    ...
    image: "/IvaDimitrovPhotos/acrossPages/corporate_headshot_blonde.jpg",
    heroImage: "/IvaDimitrovPhotos/acrossPages/corporate_headshot_blonde.jpg",
    options: [
      { label: "Event type", values: ["Conference", "Headshots", "Product", "Business"] },
  ...
  },
  {
    ...
    tagline: "Every stride, every finish line",
    description:
      "Dynamic, high-energy coverage of sporting events — capturing the intensity, emotion, and triumph of competition.",
    features: [
      "Full and half day event coverage",
      "Fully edited, high quality images",
      "Fast turnaround",
      "Custom tailored services",
    ],
    image: "/IvaDimitrovPhotos/acrossPages/card_sports_runner.png",
    heroImage: "/IvaDimitrovPhotos/acrossPages/card_sports_runner.png",
    options: [
      { label: "Event type", values: ["Marathon", "Tournament", "Match", "Other"] },
      { label: "Coverage", values: ["Half day", "Full day"] },
    ],
  },
];
